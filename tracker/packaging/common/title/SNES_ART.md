...
with nearest-neighbour sampling. The four scrolling planes are 512x224
...
subpalettes). The foreground scrolls faster than the viaduct to preserve depth.
`snes_detail.bmp` uses four colours.
